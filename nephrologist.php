...
<head>
  ...
  <title>Nephrologist Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      // Fetch all Nephrologist doctors
      $sql = "SELECT * FROM doctors WHERE specialization = 'Nephrologist'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No nephrologists found in the database.</p>";
      }
