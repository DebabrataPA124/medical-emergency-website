...
<head>
  ...
  <title>Neurologist Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      // Fetch all neurologists
      $sql = "SELECT * FROM doctors WHERE specialization = 'Neurologist'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No neurologists found in the database.</p>";
      }
