...
<head>
  ...
  <title>Ophthalmologist Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      // Fetch all Ophthalmologists
      $sql = "SELECT * FROM doctors WHERE specialization = 'Ophthalmologist'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No ophthalmologists found in the database.</p>";
      }
