...
<head>
  ...
  <title>Pediatrician Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      // Fetch all pediatricians
      $sql = "SELECT * FROM doctors WHERE specialization = 'Pediatrician'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No pediatricians found in the database.</p>";
      }
  ...
  <div class="go-back">
    <a href="speciality.php">← Go Back</a>
  </div>
</section>
