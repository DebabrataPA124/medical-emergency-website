...
<head>
  ...
  <title>Orthopedic Surgeon Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      // Fetch all orthopedic doctors
      $sql = "SELECT * FROM doctors WHERE specialization = 'Orthopedic Surgeon'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No orthopedic surgeons found in the database.</p>";
      }
