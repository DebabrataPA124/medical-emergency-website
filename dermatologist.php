...
<head>
  ...
  <title>Dermatologist Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      // Fetch all dermatologists
      $sql = "SELECT * FROM doctors WHERE specialization = 'Dermatologist'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No dermatologists found in the database.</p>";
      }
      $conn->close();
    ?>
  </div>
