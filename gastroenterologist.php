...
<head>
  ...
  <title>Gastroenterologist Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  ...
  <div class="doctor-cards">
    <?php
      ...
      $sql = "SELECT * FROM doctors WHERE specialization = 'Gastroenterologist'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No gastroenterologists found in the database.</p>";
      }
