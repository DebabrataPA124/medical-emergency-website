...
<head>
  ...
  <title>ENT Specialist Section</title>
  <style>
    body {
      background: #ffffff;
      margin: 0;
...
<section class="doctor-specialty">
  <div class="section-header">
    <h2>ENT Specialist</h2>
  </div>

  <div class="doctor-cards">
    <?php
      // Fetch ENT doctors
      $sql = "SELECT * FROM doctors WHERE specialization = 'ENT Specialist'";
      ...
      if ($result && $result->num_rows > 0) {
          ...
          echo "<p>No ENT specialists found in the database.</p>";
      }
